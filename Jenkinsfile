        ...
        stage('Security Test Zap') {
            ...
            steps {
                script {
                    ...
                    startZap(host: "127.0.0.1", port: 9095, timeout:1500 ,zapHome: "/opt/zaproxy") // Start ZAP at /opt/zaproxy/zap.sh, allowing scans on github.com (if allowedHosts is not provided, any local addresses will be used
